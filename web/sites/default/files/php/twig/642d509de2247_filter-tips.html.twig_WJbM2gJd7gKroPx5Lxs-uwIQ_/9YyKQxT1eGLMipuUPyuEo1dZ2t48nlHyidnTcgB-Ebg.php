...
class __TwigTemplate_fb827dfc7c86af701456d6be9c864991 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap5/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\drupal10\\web\\themes\\contrib\\bootstrap5\\templates\\content-edit\\filter-tips.html.twig");
    }
